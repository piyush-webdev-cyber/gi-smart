      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="absolute -right-4 bottom-4 bg-gradient-to-br from-[#1e40af] to-[#1f2937] border-2 border-[#dc2626] text-white p-4 rounded-lg shadow-lg max-w-[220px]">
              <div className="text-xs font-bold mb-2 text-[#dc2626]">PROGRAM DETAILS</div>
              <div className="text-xs leading-tight space-y-1">
                <div>120-128 Credits</div>
                <div className="text-[#dc2626] font-semibold">Tuition Fee: €12,000, Per Academic Year</div>
